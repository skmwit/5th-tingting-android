...
class FirstPagerFragment (id : Int ) : Fragment() {
    var teamMemberId = id
    ...
    override fun onCreateView(
        ...
        dataBinding = FragmentMatchingViewpagerBinding.inflate(inflater,container,false).apply {
            viewmodel = ViewModelProviders.of(this@FirstPagerFragment).get(FirstPagerFragmentViewModel::class.java)
